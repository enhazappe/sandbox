...
return array(
    ...
    'ModulIS\\Entity' => $vendorDir . '/modul-is/orm/src/ModulIS/Entity.php',
    'ModulIS\\EntityCollection' => $vendorDir . '/modul-is/orm/src/ModulIS/EntityCollection.php',
    'ModulIS\\Exception\\InvalidArgumentException' => $vendorDir . '/modul-is/orm/src/ModulIS/Exception/InvalidArgumentException.php',
    'ModulIS\\Exception\\InvalidPropertyDefinitionException' => $vendorDir . '/modul-is/orm/src/ModulIS/Exception/InvalidPropertyDefinitionException.php',
    'ModulIS\\Exception\\InvalidStateException' => $vendorDir . '/modul-is/orm/src/ModulIS/Exception/InvalidStateException.php',
    'ModulIS\\Exception\\MemberAccessException' => $vendorDir . '/modul-is/orm/src/ModulIS/Exception/MemberAccessException.php',
    'ModulIS\\Exception\\NotSupportedException' => $vendorDir . '/modul-is/orm/src/ModulIS/Exception/NotSupportedException.php',
    'ModulIS\\MySqlDriver' => $vendorDir . '/modul-is/orm/src/ModulIS/MySqlDriver.php',
    'ModulIS\\Record' => $vendorDir . '/modul-is/orm/src/ModulIS/Record.php',
    'ModulIS\\Reflection\\AnnotationProperty' => $vendorDir . '/modul-is/orm/src/ModulIS/Reflection/AnnotationProperty.php',
    'ModulIS\\Reflection\\EntityProperty' => $vendorDir . '/modul-is/orm/src/ModulIS/Reflection/EntityProperty.php',
    'ModulIS\\Reflection\\EntityType' => $vendorDir . '/modul-is/orm/src/ModulIS/Reflection/EntityType.php',
    'ModulIS\\Repository' => $vendorDir . '/modul-is/orm/src/ModulIS/Repository.php',
    'ModulIS\\Transaction' => $vendorDir . '/modul-is/orm/src/ModulIS/Transaction.php',
